...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($password) || empty($employee_id)) {
        ...
        // แสดง IP Address
        echo "<script>alert('IP ของคุณคือ: $user_ip');</script>";
...
.lift-control {
    ...
    .login-container {
        ...
        perspective: 1000px;
        animation: login-container 0.6s ease-out, pulse 2.5s infinite alternate; 
    }
...
<script>
    ...
    setTimeout(() => {
        liftControl.style.transform = 'translateY(0)'; 
    }, 500); // รอ 0.5 วินาที
});
</script>
</body>

...
function getStatusClassAndText($status_id) {
    switch ($status_id) {
        case 1: return ['class' => 'bg-blue-500 neon-glow fa fa-car', 'text' => 'ว่าง']; 
        case 6: return ['class' => 'bg-yellow-400 text-black neon-glow fa fa-parking', 'text' => 'จอง']; 
        case 7: return ['class' => 'bg-green-500 neon-glow fa fa-check-circle', 'text' => 'จอด']; 
        case 3: return ['class' => 'bg-red-500 neon-glow fa fa-exclamation-triangle', 'text' => 'พัง']; 
        default: return ['class' => 'bg-gray-300 neon-glow fa fa-question-circle', 'text' => 'ไม่ทราบ']; 
    }
}
?>
...
<head>
    ...
    setInterval(() => {
        if (currentZoneId !== null) {
            fetchZoneDetails(currentZoneId);
        }
    }, 5000);
</script>
